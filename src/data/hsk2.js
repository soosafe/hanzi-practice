export const HSK2_WORDS = [
  ...
  { h: '看书', p: 'kàn shū', m: 'To read books', cat: 'hobbies', level: 2,
  ...
  { h: '听音乐', p: 'tīng yīn yuè', m: 'To listen to music', cat: 'hobbies', level: 2,
  ...
  { h: '开车', p: 'kāi chē', m: 'To drive a car', cat: 'hobbies', level: 2,
  ...
  { h: '岳父', p: 'yuè fù', m: "Wife's father (father-in-law)", cat: 'family', level: 2,
  ...
  { h: '公公', p: 'gōng gong', m: "Husband's father (father-in-law)", cat: 'family', level: 2,
  ...
  { h: '岳母', p: 'yuè mǔ', m: "Wife's mother (mother-in-law)", cat: 'family', level: 2,
  ...
  { h: '婆婆', p: 'pó po', m: "Husband's mother (mother-in-law)", cat: 'family', level: 2,
  ...
  { h: '女婿', p: 'nǚ xù', m: 'Son-in-law', cat: 'family', level: 2,
  ...
  { h: '儿媳', p: 'ér xí', m: 'Daughter-in-law', cat: 'family', level: 2,
  ...
  { h: '双胞胎', p: 'shuāng bāo tāi', m: 'Twins', cat: 'family', level: 2,
  ...
  { h: '男朋友', p: 'nán péng yǒu', m: 'Boyfriend', cat: 'family', level: 2,
  ...
  { h: '前男友', p: 'qián nán yǒu', m: 'Ex-boyfriend', cat: 'family', level: 2,
  ...
  { h: '女朋友', p: 'nǚ péng yǒu', m: 'Girlfriend', cat: 'family', level: 2,
  ...
  { h: '前女友', p: 'qián nǚ yǒu', m: 'Ex-girlfriend', cat: 'family', level: 2,
  ...
  { h: '结婚了', p: 'jié hūn le', m: 'Married', cat: 'family', level: 2,
  ...
  { h: '订婚', p: 'dìng hūn', m: 'Engaged', cat: 'family', level: 2,
  ...
  { h: '单身', p: 'dān shēn', m: 'Single', cat: 'family', level: 2,
  ...
  { h: '家庭', p: 'jiā tíng', m: 'Family / Household', cat: 'family', level: 2,
  ...
  { h: '朋友', p: 'péng yǒu', m: 'Friend', cat: 'family', level: 2,
  ...
  { h: '同事', p: 'tóng shì', m: 'Colleague', cat: 'words', level: 2,
  ...
  { h: '室友', p: 'shì yǒu', m: 'Flatmate / Roommate', cat: 'words', level: 2,
  ...
  { h: '职员', p: 'zhí yuán', m: 'Employee', cat: 'words', level: 2,
  ...
  { h: '上司', p: 'shàng si', m: 'Boss', cat: 'words', level: 2,
  ...
  { h: '计划', p: 'jì huà', m: 'Plans', cat: 'phrases', level: 2,
  ...
  { h: '怎么样？', p: 'zěn me yàng', m: 'How about...?', cat: 'phrases', level: 2,
  ...
  { h: '应该', p: 'yīng gāi', m: 'Should / Shall', cat: 'phrases', level: 2,
  ...
  { h: '你介意…？', p: 'nǐ jiè yì', m: 'Do you mind...?', cat: 'phrases', level: 2,
  ...
  { h: '很抱歉，我不行。', p: 'hěn bào qiàn, wǒ bù xíng', m: "Sorry, I can't", cat: 'phrases', level: 2,
